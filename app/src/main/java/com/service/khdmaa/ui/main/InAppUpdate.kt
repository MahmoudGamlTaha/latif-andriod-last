package com.service.khdmaa.ui.main
...
class InAppUpdate(activity: Activity) : InstallStateUpdatedListener {
    ...
    init {
        ...
        appUpdateManager.appUpdateInfo.addOnSuccessListener { info ->
            ...
            Utiles.log_D("UpdateAvailability.UPDATE_AVAILABLE", UpdateAvailability.UPDATE_AVAILABLE)
            Utiles.log_D("info.updateAvailability()", info.updateAvailability())
...
//            }
    ...
    private fun startUpdate(info: AppUpdateInfo, type: Int) {
        Utiles.log_D("startUpdate", info.updateAvailability())
    ...
    private fun flexibleUpdateDownloadCompleted() {
        Snackbar.make(
            parentActivity.findViewById(R.id.logo),
