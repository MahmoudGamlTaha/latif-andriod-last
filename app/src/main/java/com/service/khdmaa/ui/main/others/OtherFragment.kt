...
@AndroidEntryPoint
class OtherFragment : BaseFragment<PetsViewModel, FragmentServicesBinding>() {
    ...
    val selectOther =object :PetsAdapter.CategoryActions{
    ...
    private fun setupList() {
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.getCategoriesList(AppConstants.OTHERS).collect {
                if (!it.isNullOrEmpty()) {
                    adapter_.list = (it)
